...
<form action="<?php echo JRoute::_(JUri::getInstance()->toString(), true, $params->get('usesecure')); ?>" method="post" id="login-form">
	...
	<div class="userdata">
			...
			<div class="input-group">
				<?php if (!$params->get('usetext')) : ?>
					<span class="input-group-addon">
						<span class="fa fa-user hasTooltip" title="<?php echo JText::_('MOD_CMSOCIALCONNECT_LOGIN_VALUE_USERNAME') ?>"></span>
						<label for="modlgn-username" class="element-invisible"><?php echo JText::_('MOD_CMSOCIALCONNECT_LOGIN_VALUE_USERNAME'); ?></label>
					</span>
					<input id="modlgn-username" type="text" name="username" class="input form-control" tabindex="0" size="18" placeholder="<?php echo JText::_('MOD_CMSOCIALCONNECT_LOGIN_VALUE_USERNAME') ?>" />
				<?php else: ?>
					<label for="modlgn-username"><?php echo JText::_('MOD_CMSOCIALCONNECT_LOGIN_VALUE_USERNAME') ?></label>
					<input id="modlgn-username" type="text" name="username" class="input form-control" tabindex="0" size="18" placeholder="<?php echo JText::_('MOD_CMSOCIALCONNECT_LOGIN_VALUE_USERNAME') ?>" />
				<?php endif; ?>
			</div>
		</div>
		<div id="form-login-password" class="form-group">
			<div class="input-group">
				...
				<?php else: ?>
					...
					<input id="modlgn-passwd" type="password" name="password" class="iinput form-control" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_PASSWORD') ?>" />
				<?php endif; ?>
			</div>
		</div>
		...
		<div id="form-login-remember" class="control-group">
			<label for="modlgn-remember" class="control-label"><input id="modlgn-remember" type="checkbox" name="remember" class="input" value="yes"/> <?php echo JText::_('MOD_CMSOCIALCONNECT_LOGIN_REMEMBER_ME') ?></label>
		</div>
		<?php endif; ?>
		...
		<?php
			...
			<?php if ($usersConfig->get('allowUserRegistration')) : ?>
				<li>
					...
					<?php echo JText::_('MOD_CMSOCIALCONNECT_LOGIN_REGISTER'); ?> <span class="fa fa-chevron-right"></span></a>
				</li>
			<?php endif; ?>
				<li>
					<a href="<?php echo JRoute::_('index.php?option=com_users&view=remind&Itemid=' . UsersHelperRoute::getRemindRoute()); ?>">
					<?php echo JText::_('MOD_CMSOCIALCONNECT_LOGIN_FORGOT_YOUR_USERNAME'); ?></a>
				</li>
				<li>
					<a href="<?php echo JRoute::_('index.php?option=com_users&view=reset&Itemid=' . UsersHelperRoute::getResetRoute()); ?>">
					<?php echo JText::_('MOD_CMSOCIALCONNECT_LOGIN_FORGOT_YOUR_PASSWORD'); ?></a>
				</li>
			</ul>
