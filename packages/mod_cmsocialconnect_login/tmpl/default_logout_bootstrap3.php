...
<?php if ($params->get('greeting')) : ?>
	...
	<?php if ($params->get('name') == 0) : {
		echo JText::sprintf('MOD_CMSOCIALCONNECT_LOGIN_HINAME', htmlspecialchars($user->get('name')));
	} else : {
		echo JText::sprintf('MOD_CMSOCIALCONNECT_LOGIN_HINAME', htmlspecialchars($user->get('username')));
	} endif; ?>
	</div>
<?php endif; ?>
